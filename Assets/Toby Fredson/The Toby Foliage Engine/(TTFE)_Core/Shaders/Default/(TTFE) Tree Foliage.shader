	...
	SubShader
	{
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				float3 staticSwitch622_g1594 = float3(0,1,0);
				#else
				float3 staticSwitch622_g1594 = inputMesh.normalOS;
				#endif
				float3 LightDetect_Output597_g1594 = staticSwitch622_g1594;
				...
				inputMesh.normalOS = LightDetect_Output597_g1594;
						...
						)
			{
				...
				float2 uv_AlbedoMap513_g1594 = packedInput.ase_texcoord5.xy;
				float2 uv_AlbedoMap662_g1594 = packedInput.ase_texcoord5.xy;
				float4 tex2DNode662_g1594 = tex2D( _AlbedoMap, uv_AlbedoMap662_g1594 );
				float2 uv_NoiseMapGrayscale669_g1594 = packedInput.ase_texcoord5.xy;
				float4 transform741_g1594 = mul(GetObjectToWorldMatrix(),float4( 0,0,0,1 ));
				transform741_g1594.xyz = GetAbsolutePositionWS((transform741_g1594).xyz);
				float dotResult4_g1596 = dot( transform741_g1594.xy , float2( 12.9898,78.233 ) );
				float lerpResult10_g1596 = lerp( 0.0 , 1.0 , frac( ( sin( dotResult4_g1596 ) * 43758.55 ) ));
				float temp_output_742_0_g1594 = lerpResult10_g1596;
				float normalizeResult811_g1594 = normalize( temp_output_742_0_g1594 );
				float3 normalizeResult439_g1594 = normalize( packedInput.ase_texcoord6.xyz );
				float DryLeafPositionMask443_g1594 = ( (distance( normalizeResult439_g1594 , float3( 0,0.8,0 ) )*1.0 + 0.0) * 1 );
				float4 lerpResult677_g1594 = lerp( ( _DryLeafColor * ( tex2DNode662_g1594.g * 2 ) ) , tex2DNode662_g1594 , saturate( (( ( tex2D( _NoiseMapGrayscale, uv_NoiseMapGrayscale669_g1594 ).r * (( _NormalizeSeasons )?( normalizeResult811_g1594 ):( temp_output_742_0_g1594 )) * DryLeafPositionMask443_g1594 ) - _SeasonChangeGlobal )*_DryLeavesScale + _DryLeavesOffset) ));
				float4 SeasonControl_Output676_g1594 = lerpResult677_g1594;
				Gradient gradient752_g1594 = NewGradient( 0, 2, 2, float4( 1, 0.276868, 0, 0 ), float4( 0, 1, 0.7818019, 1 ), 0, 0, 0, 0, 0, 0, float2( 1, 0 ), float2( 1, 1 ), 0, 0, 0, 0, 0, 0 );
				float4 transform754_g1594 = mul(GetObjectToWorldMatrix(),float4( 0,0,0,1 ));
				transform754_g1594.xyz = GetAbsolutePositionWS((transform754_g1594).xyz);
				float dotResult4_g1595 = dot( transform754_g1594.xy , float2( 12.9898,78.233 ) );
				float lerpResult10_g1595 = lerp( 0.0 , 1.0 , frac( ( sin( dotResult4_g1595 ) * 43758.55 ) ));
				float4 lerpResult515_g1594 = lerp( SeasonControl_Output676_g1594 , ( ( SeasonControl_Output676_g1594 * 0.5 ) + ( SampleGradient( gradient752_g1594, lerpResult10_g1595 ) * SeasonControl_Output676_g1594 ) ) , _ColorVariation);
				float2 uv_MaskMapRGBA505_g1594 = packedInput.ase_texcoord5.xy;
				float4 lerpResult521_g1594 = lerp( tex2D( _AlbedoMap, uv_AlbedoMap513_g1594 ) , lerpResult515_g1594 , (( _BranchMaskR )?( tex2D( _MaskMapRGBA, uv_MaskMapRGBA505_g1594 ).r ):( 1.0 )));
				float3 temp_output_465_0_g1594 = ( ( packedInput.ase_texcoord6.xyz * float3( 2,1.3,2 ) ) / 25.0 );
				float dotResult471_g1594 = dot( temp_output_465_0_g1594 , temp_output_465_0_g1594 );
				float3 normalizeResult457_g1594 = normalize( packedInput.ase_texcoord6.xyz );
				float SelfShading601_g1594 = saturate( (( pow( abs( saturate( dotResult471_g1594 ) ) , 1.5 ) + ( ( 1.0 - (distance( normalizeResult457_g1594 , float3( 0,0.8,0 ) )*0.5 + 0.0) ) * 0.6 ) )*0.92 + -0.16) );
				#ifdef _SELFSHADINGVERTEXCOLOR_ON
				float4 staticSwitch618_g1594 = ( lerpResult521_g1594 * (SelfShading601_g1594*_VertexLighting + _VertexShadow) );
				#else
				float4 staticSwitch618_g1594 = lerpResult521_g1594;
				#endif
				float4 GrassColorVariation_Output586_g1594 = staticSwitch618_g1594;
				float4 transform487_g1594 = mul(GetObjectToWorldMatrix(),float4( packedInput.ase_texcoord6.xyz , 0.0 ));
				transform487_g1594.xyz = GetAbsolutePositionWS((transform487_g1594).xyz);
				float dotResult566_g1594 = dot( float4( V , 0.0 ) , -( float4( -_DirectionalLightDatas[0].forward , 0.0 ) + ( (( _TranslucencyTreeTangents )?( float4( packedInput.ase_normal , 0.0 ) ):( transform487_g1594 )) * _TranslucencyRange ) ) );
				float2 uv_MaskMapRGBA516_g1594 = packedInput.ase_texcoord5.xy;
				...
				float TobyTranslucency526_g1594 = ( saturate( dotResult566_g1594 ) * tex2D( _MaskMapRGBA, uv_MaskMapRGBA516_g1594 ).b * ase_lightColor.a );
				float TranslucencyIntensity616_g1594 = _TranslucencyPower;
				float4 Albedo_Output613_g1594 = ( ( _AlbedoColor * GrassColorVariation_Output586_g1594 ) * (1.0 + (TobyTranslucency526_g1594 - 0.0) * (TranslucencyIntensity616_g1594 - 1.0) / (1.0 - 0.0)) );
				
				float2 uv_NormalMap531_g1594 = packedInput.ase_texcoord5.xy;
				float3 unpack531_g1594 = UnpackNormalScale( tex2D( _NormalMap, uv_NormalMap531_g1594 ), _NormalIntenisty );
				unpack531_g1594.z = lerp( 1, unpack531_g1594.z, saturate(_NormalIntenisty) );
				float3 tex2DNode531_g1594 = unpack531_g1594;
				float3 break539_g1594 = tex2DNode531_g1594;
				float3 appendResult552_g1594 = (float3(break539_g1594.x , break539_g1594.y , ( break539_g1594.z * isFrontFace )));
				float3 Normal_Output557_g1594 = (( _NormalBackFaceFixBranch )?( appendResult552_g1594 ):( tex2DNode531_g1594 ));
				
				float2 uv_MaskMapRGBA535_g1594 = packedInput.ase_texcoord5.xy;
				float4 tex2DNode535_g1594 = tex2D( _MaskMapRGBA, uv_MaskMapRGBA535_g1594 );
				float Smoothness_Output558_g1594 = ( tex2DNode535_g1594.a * _SmoothnessIntensity );
				
				float AoMapBase538_g1594 = tex2DNode535_g1594.g;
				float AmbientOcclusion_Output582_g1594 = pow( abs( AoMapBase538_g1594 ) , _AmbientOcclusionIntensity );
				
				float2 uv_AlbedoMap555_g1594 = packedInput.ase_texcoord5.xy;
				float Opacity_Output559_g1594 = tex2D( _AlbedoMap, uv_AlbedoMap555_g1594 ).a;
				
				float translucency792_g1594 = saturate( ( 1.0 - tex2DNode535_g1594.b ) );
				float Translucency_Output818_g1594 = translucency792_g1594;
				
				surfaceDescription.BaseColor = Albedo_Output613_g1594.rgb;
				surfaceDescription.Normal = Normal_Output557_g1594;
				...
				surfaceDescription.Smoothness = Smoothness_Output558_g1594;
				surfaceDescription.Occlusion = AmbientOcclusion_Output582_g1594;
				surfaceDescription.Alpha = Opacity_Output559_g1594;
				...
				#if defined(_HAS_REFRACTION) || defined(_MATERIAL_FEATURE_TRANSMISSION)
				surfaceDescription.Thickness = Translucency_Output818_g1594;
				#endif
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				BuiltinData builtinData;
				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;
				float2 uv_AlbedoMap513_g1594 = packedInput.ase_texcoord2.xy;
				float2 uv_AlbedoMap662_g1594 = packedInput.ase_texcoord2.xy;
				float4 tex2DNode662_g1594 = tex2D( _AlbedoMap, uv_AlbedoMap662_g1594 );
				float2 uv_NoiseMapGrayscale669_g1594 = packedInput.ase_texcoord2.xy;
				float4 transform741_g1594 = mul(GetObjectToWorldMatrix(),float4( 0,0,0,1 ));
				transform741_g1594.xyz = GetAbsolutePositionWS((transform741_g1594).xyz);
				float dotResult4_g1596 = dot( transform741_g1594.xy , float2( 12.9898,78.233 ) );
				float lerpResult10_g1596 = lerp( 0.0 , 1.0 , frac( ( sin( dotResult4_g1596 ) * 43758.55 ) ));
				float temp_output_742_0_g1594 = lerpResult10_g1596;
				float normalizeResult811_g1594 = normalize( temp_output_742_0_g1594 );
				float3 normalizeResult439_g1594 = normalize( packedInput.ase_texcoord3.xyz );
				float DryLeafPositionMask443_g1594 = ( (distance( normalizeResult439_g1594 , float3( 0,0.8,0 ) )*1.0 + 0.0) * 1 );
				float4 lerpResult677_g1594 = lerp( ( _DryLeafColor * ( tex2DNode662_g1594.g * 2 ) ) , tex2DNode662_g1594 , saturate( (( ( tex2D( _NoiseMapGrayscale, uv_NoiseMapGrayscale669_g1594 ).r * (( _NormalizeSeasons )?( normalizeResult811_g1594 ):( temp_output_742_0_g1594 )) * DryLeafPositionMask443_g1594 ) - _SeasonChangeGlobal )*_DryLeavesScale + _DryLeavesOffset) ));
				float4 SeasonControl_Output676_g1594 = lerpResult677_g1594;
				Gradient gradient752_g1594 = NewGradient( 0, 2, 2, float4( 1, 0.276868, 0, 0 ), float4( 0, 1, 0.7818019, 1 ), 0, 0, 0, 0, 0, 0, float2( 1, 0 ), float2( 1, 1 ), 0, 0, 0, 0, 0, 0 );
				...
				float lerpResult10_g1595 = lerp( 0.0 , 1.0 , frac( ( sin( dotResult4_g1595 ) * 43758.55 ) ));
				float4 lerpResult515_g1594 = lerp( SeasonControl_Output676_g1594 , ( ( SeasonControl_Output676_g1594 * 0.5 ) + ( SampleGradient( gradient752_g1594, lerpResult10_g1595 ) * SeasonControl_Output676_g1594 ) ) , _ColorVariation);
				float2 uv_MaskMapRGBA505_g1594 = packedInput.ase_texcoord2.xy;
				float4 lerpResult521_g1594 = lerp( tex2D( _AlbedoMap, uv_AlbedoMap513_g1594 ) , lerpResult515_g1594 , (( _BranchMaskR )?( tex2D( _MaskMapRGBA, uv_MaskMapRGBA505_g1594 ).r ):( 1.0 )));
				float3 temp_output_465_0_g1594 = ( ( packedInput.ase_texcoord3.xyz * float3( 2,1.3,2 ) ) / 25.0 );
				float dotResult471_g1594 = dot( temp_output_465_0_g1594 , temp_output_465_0_g1594 );
				float3 normalizeResult457_g1594 = normalize( packedInput.ase_texcoord3.xyz );
				float SelfShading601_g1594 = saturate( (( pow( abs( saturate( dotResult471_g1594 ) ) , 1.5 ) + ( ( 1.0 - (distance( normalizeResult457_g1594 , float3( 0,0.8,0 ) )*0.5 + 0.0) ) * 0.6 ) )*0.92 + -0.16) );
				#ifdef _SELFSHADINGVERTEXCOLOR_ON
				float4 staticSwitch618_g1594 = ( lerpResult521_g1594 * (SelfShading601_g1594*_VertexLighting + _VertexShadow) );
				#else
				...
				float4 transform487_g1594 = mul(GetObjectToWorldMatrix(),float4( packedInput.ase_texcoord3.xyz , 0.0 ));
				transform487_g1594.xyz = GetAbsolutePositionWS((transform487_g1594).xyz);
				float dotResult566_g1594 = dot( float4( ase_worldViewDir , 0.0 ) , -( float4( -_DirectionalLightDatas[0].forward , 0.0 ) + ( (( _TranslucencyTreeTangents )?( float4( packedInput.ase_normal , 0.0 ) ):( transform487_g1594 )) * _TranslucencyRange ) ) );
				float2 uv_MaskMapRGBA516_g1594 = packedInput.ase_texcoord2.xy;
				float ase_lightIntensity = max( max( _DirectionalLightDatas[0].color.r, _DirectionalLightDatas[0].color.g ), _DirectionalLightDatas[0].color.b );
				float4 ase_lightColor = float4( _DirectionalLightDatas[0].color.rgb / ase_lightIntensity, ase_lightIntensity );
				float TobyTranslucency526_g1594 = ( saturate( dotResult566_g1594 ) * tex2D( _MaskMapRGBA, uv_MaskMapRGBA516_g1594 ).b * ase_lightColor.a );
				float TranslucencyIntensity616_g1594 = _TranslucencyPower;
				...
				float2 uv_NormalMap531_g1594 = packedInput.ase_texcoord2.xy;
				float3 unpack531_g1594 = UnpackNormalScale( tex2D( _NormalMap, uv_NormalMap531_g1594 ), _NormalIntenisty );
				unpack531_g1594.z = lerp( 1, unpack531_g1594.z, saturate(_NormalIntenisty) );
				float3 tex2DNode531_g1594 = unpack531_g1594;
				float3 break539_g1594 = tex2DNode531_g1594;
				...
				float2 uv_MaskMapRGBA535_g1594 = packedInput.ase_texcoord2.xy;
				float4 tex2DNode535_g1594 = tex2D( _MaskMapRGBA, uv_MaskMapRGBA535_g1594 );
				float Smoothness_Output558_g1594 = ( tex2DNode535_g1594.a * _SmoothnessIntensity );
				...
				float2 uv_AlbedoMap555_g1594 = packedInput.ase_texcoord2.xy;
				float Opacity_Output559_g1594 = tex2D( _AlbedoMap, uv_AlbedoMap555_g1594 ).a;
		...
		Pass
		{
			...
			UNITY_SETUP_INSTANCE_ID(packedInput);
				...
				float2 uv_AlbedoMap555_g1594 = packedInput.ase_texcoord1.xy;
				float Opacity_Output559_g1594 = tex2D( _AlbedoMap, uv_AlbedoMap555_g1594 ).a;
		...
		Pass
		{
			...
			UNITY_SETUP_INSTANCE_ID(packedInput);
				...
				float2 uv_NormalMap531_g1594 = packedInput.ase_texcoord3.xy;
				float3 unpack531_g1594 = UnpackNormalScale( tex2D( _NormalMap, uv_NormalMap531_g1594 ), _NormalIntenisty );
				unpack531_g1594.z = lerp( 1, unpack531_g1594.z, saturate(_NormalIntenisty) );
				float3 tex2DNode531_g1594 = unpack531_g1594;
				float3 break539_g1594 = tex2DNode531_g1594;
				...
				float2 uv_MaskMapRGBA535_g1594 = packedInput.ase_texcoord3.xy;
				float4 tex2DNode535_g1594 = tex2D( _MaskMapRGBA, uv_MaskMapRGBA535_g1594 );
				float Smoothness_Output558_g1594 = ( tex2DNode535_g1594.a * _SmoothnessIntensity );
				
				float2 uv_AlbedoMap555_g1594 = packedInput.ase_texcoord3.xy;
				float Opacity_Output559_g1594 = tex2D( _AlbedoMap, uv_AlbedoMap555_g1594 ).a;
		...
		Pass
		{
						...
						)
			{
				...
				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;
				float2 uv_AlbedoMap513_g1594 = packedInput.ase_texcoord7.xy;
				float2 uv_AlbedoMap662_g1594 = packedInput.ase_texcoord7.xy;
				float4 tex2DNode662_g1594 = tex2D( _AlbedoMap, uv_AlbedoMap662_g1594 );
				float2 uv_NoiseMapGrayscale669_g1594 = packedInput.ase_texcoord7.xy;
				float4 transform741_g1594 = mul(GetObjectToWorldMatrix(),float4( 0,0,0,1 ));
				transform741_g1594.xyz = GetAbsolutePositionWS((transform741_g1594).xyz);
				float dotResult4_g1596 = dot( transform741_g1594.xy , float2( 12.9898,78.233 ) );
				float lerpResult10_g1596 = lerp( 0.0 , 1.0 , frac( ( sin( dotResult4_g1596 ) * 43758.55 ) ));
				float temp_output_742_0_g1594 = lerpResult10_g1596;
				float normalizeResult811_g1594 = normalize( temp_output_742_0_g1594 );
				float3 normalizeResult439_g1594 = normalize( packedInput.ase_texcoord8.xyz );
				float DryLeafPositionMask443_g1594 = ( (distance( normalizeResult439_g1594 , float3( 0,0.8,0 ) )*1.0 + 0.0) * 1 );
				float4 lerpResult677_g1594 = lerp( ( _DryLeafColor * ( tex2DNode662_g1594.g * 2 ) ) , tex2DNode662_g1594 , saturate( (( ( tex2D( _NoiseMapGrayscale, uv_NoiseMapGrayscale669_g1594 ).r * (( _NormalizeSeasons )?( normalizeResult811_g1594 ):( temp_output_742_0_g1594 )) * DryLeafPositionMask443_g1594 ) - _SeasonChangeGlobal )*_DryLeavesScale + _DryLeavesOffset) ));
				float4 SeasonControl_Output676_g1594 = lerpResult677_g1594;
				Gradient gradient752_g1594 = NewGradient( 0, 2, 2, float4( 1, 0.276868, 0, 0 ), float4( 0, 1, 0.7818019, 1 ), 0, 0, 0, 0, 0, 0, float2( 1, 0 ), float2( 1, 1 ), 0, 0, 0, 0, 0, 0 );
				...
				float lerpResult10_g1595 = lerp( 0.0 , 1.0 , frac( ( sin( dotResult4_g1595 ) * 43758.55 ) ));
				float4 lerpResult515_g1594 = lerp( SeasonControl_Output676_g1594 , ( ( SeasonControl_Output676_g1594 * 0.5 ) + ( SampleGradient( gradient752_g1594, lerpResult10_g1595 ) * SeasonControl_Output676_g1594 ) ) , _ColorVariation);
				float2 uv_MaskMapRGBA505_g1594 = packedInput.ase_texcoord7.xy;
				float4 lerpResult521_g1594 = lerp( tex2D( _AlbedoMap, uv_AlbedoMap513_g1594 ) , lerpResult515_g1594 , (( _BranchMaskR )?( tex2D( _MaskMapRGBA, uv_MaskMapRGBA505_g1594 ).r ):( 1.0 )));
				float3 temp_output_465_0_g1594 = ( ( packedInput.ase_texcoord8.xyz * float3( 2,1.3,2 ) ) / 25.0 );
				float dotResult471_g1594 = dot( temp_output_465_0_g1594 , temp_output_465_0_g1594 );
				float3 normalizeResult457_g1594 = normalize( packedInput.ase_texcoord8.xyz );
				float SelfShading601_g1594 = saturate( (( pow( abs( saturate( dotResult471_g1594 ) ) , 1.5 ) + ( ( 1.0 - (distance( normalizeResult457_g1594 , float3( 0,0.8,0 ) )*0.5 + 0.0) ) * 0.6 ) )*0.92 + -0.16) );
				#ifdef _SELFSHADINGVERTEXCOLOR_ON
				float4 staticSwitch618_g1594 = ( lerpResult521_g1594 * (SelfShading601_g1594*_VertexLighting + _VertexShadow) );
				#else
				...
				#endif
				float4 GrassColorVariation_Output586_g1594 = staticSwitch618_g1594;
				float4 transform487_g1594 = mul(GetObjectToWorldMatrix(),float4( packedInput.ase_texcoord8.xyz , 0.0 ));
				transform487_g1594.xyz = GetAbsolutePositionWS((transform487_g1594).xyz);
				float dotResult566_g1594 = dot( float4( V , 0.0 ) , -( float4( -_DirectionalLightDatas[0].forward , 0.0 ) + ( (( _TranslucencyTreeTangents )?( float4( packedInput.ase_normal , 0.0 ) ):( transform487_g1594 )) * _TranslucencyRange ) ) );
				float2 uv_MaskMapRGBA516_g1594 = packedInput.ase_texcoord7.xy;
				float ase_lightIntensity = max( max( _DirectionalLightDatas[0].color.r, _DirectionalLightDatas[0].color.g ), _DirectionalLightDatas[0].color.b );
				float4 ase_lightColor = float4( _DirectionalLightDatas[0].color.rgb / ase_lightIntensity, ase_lightIntensity );
				float TobyTranslucency526_g1594 = ( saturate( dotResult566_g1594 ) * tex2D( _MaskMapRGBA, uv_MaskMapRGBA516_g1594 ).b * ase_lightColor.a );
				float TranslucencyIntensity616_g1594 = _TranslucencyPower;
				...
				float2 uv_NormalMap531_g1594 = packedInput.ase_texcoord7.xy;
				float3 unpack531_g1594 = UnpackNormalScale( tex2D( _NormalMap, uv_NormalMap531_g1594 ), _NormalIntenisty );
				unpack531_g1594.z = lerp( 1, unpack531_g1594.z, saturate(_NormalIntenisty) );
				float3 tex2DNode531_g1594 = unpack531_g1594;
				float3 break539_g1594 = tex2DNode531_g1594;
				...
				float2 uv_MaskMapRGBA535_g1594 = packedInput.ase_texcoord7.xy;
				float4 tex2DNode535_g1594 = tex2D( _MaskMapRGBA, uv_MaskMapRGBA535_g1594 );
				float Smoothness_Output558_g1594 = ( tex2DNode535_g1594.a * _SmoothnessIntensity );
				...
				float2 uv_AlbedoMap555_g1594 = packedInput.ase_texcoord7.xy;
				float Opacity_Output559_g1594 = tex2D( _AlbedoMap, uv_AlbedoMap555_g1594 ).a;
...
Node;AmplifyShaderEditor.DiffusionProfileNode;2870;944,368;Float;False;Property;_DiffusionProfile;Diffusion Profile;38;0;Create;True;0;0;0;False;0;False;fd758c9e27d8d784980e86ac31c1676f;fd758c9e27d8d784980e86ac31c1676f;False;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=BD868C6C197DF9357674955953F2FD1D2C072513
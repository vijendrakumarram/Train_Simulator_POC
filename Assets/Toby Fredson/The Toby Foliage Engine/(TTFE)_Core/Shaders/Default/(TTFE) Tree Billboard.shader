	...
	SubShader
	{
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				float3 appendResult256_g1340 = (float3(0.0 , 0.0 , saturate( inputMesh.positionOS ).z));
				float3 break252_g1340 = inputMesh.positionOS;
				float3 appendResult255_g1340 = (float3(break252_g1340.x , ( break252_g1340.y * 0.15 ) , 0.0));
				float mulTime263_g1340 = _TimeParameters.x * 2.1;
				float3 temp_cast_0 = (inputMesh.positionOS.y).xxx;
				float2 appendResult300_g1340 = (float2(inputMesh.positionOS.x , inputMesh.positionOS.z));
				float3 temp_output_303_0_g1340 = ( cross( temp_cast_0 , float3( appendResult300_g1340 ,  0.0 ) ) * 0.005 );
				float3 appendResult270_g1340 = (float3(0.0 , inputMesh.positionOS.y , 0.0));
				float3 break269_g1340 = inputMesh.positionOS;
				float3 appendResult271_g1340 = (float3(break269_g1340.x , 0.0 , ( break269_g1340.z * 0.15 )));
				float mulTime282_g1340 = _TimeParameters.x * 2.3;
				float3 appendResult293_g1340 = (float3(inputMesh.positionOS.x , 0.0 , 0.0));
				float3 break288_g1340 = inputMesh.positionOS;
				float3 appendResult292_g1340 = (float3(0.0 , ( break288_g1340.y * 0.2 ) , ( break288_g1340.z * 0.4 )));
				float mulTime249_g1340 = _TimeParameters.x * 2.0;
				float3 ase_worldPos = GetAbsolutePositionWS( TransformObjectToWorld( (inputMesh.positionOS).xyz ) );
				float3 normalizeResult155_g1340 = normalize( ase_worldPos );
				float mulTime161_g1340 = _TimeParameters.x * 0.25;
				float simplePerlin2D159_g1340 = snoise( ( normalizeResult155_g1340 + mulTime161_g1340 ).xy*0.43 );
				float WindMask_LargeB169_g1340 = ( simplePerlin2D159_g1340 * 1.5 );
				float3 normalizeResult162_g1340 = normalize( ase_worldPos );
				float mulTime167_g1340 = _TimeParameters.x * 0.26;
				float simplePerlin2D166_g1340 = snoise( ( normalizeResult162_g1340 + mulTime167_g1340 ).xy*0.7 );
				float WindMask_LargeC170_g1340 = ( simplePerlin2D166_g1340 * 1.5 );
				float mulTime133_g1340 = _TimeParameters.x * 3.2;
				float3 worldToObj126_g1340 = mul( GetWorldToObjectMatrix(), float4( GetCameraRelativePositionWS(inputMesh.positionOS), 1 ) ).xyz;
				float3 temp_output_135_0_g1340 = ( mulTime133_g1340 + ( 0.02 * worldToObj126_g1340.x ) + ( worldToObj126_g1340.y * 0.14 ) + ( worldToObj126_g1340.z * 0.16 ) + float3(0.4,0.3,0.1) );
				float3 ase_objectScale = float3( length( GetObjectToWorldMatrix()[ 0 ].xyz ), length( GetObjectToWorldMatrix()[ 1 ].xyz ), length( GetObjectToWorldMatrix()[ 2 ].xyz ) );
				float mulTime111_g1340 = _TimeParameters.x * 2.3;
				float3 worldToObj103_g1340 = mul( GetWorldToObjectMatrix(), float4( GetCameraRelativePositionWS(inputMesh.positionOS), 1 ) ).xyz;
				float3 temp_output_106_0_g1340 = ( mulTime111_g1340 + ( 0.2 * worldToObj103_g1340 ) + float3(0.4,0.3,0.1) );
				float mulTime118_g1340 = _TimeParameters.x * 3.6;
				float3 temp_cast_4 = (inputMesh.positionOS.x).xxx;
				float3 worldToObj114_g1340 = mul( GetWorldToObjectMatrix(), float4( GetCameraRelativePositionWS(temp_cast_4), 1 ) ).xyz;
				float temp_output_119_0_g1340 = ( mulTime118_g1340 + ( 0.2 * worldToObj114_g1340.x ) );
				float3 temp_cast_5 = (0.0).xxx;
				#if defined(_WINDTYPE_GENTLEBREEZE)
				float3 staticSwitch312_g1340 = ( ( ( ( ( ( appendResult256_g1340 + ( appendResult255_g1340 * cos( mulTime263_g1340 ) ) + ( cross( float3(1.2,0.6,1) , ( appendResult255_g1340 * float3(0.7,1,0.8) ) ) * sin( mulTime263_g1340 ) ) ) * temp_output_303_0_g1340 ) * 0.08 ) + ( ( ( appendResult270_g1340 + ( appendResult271_g1340 * cos( mulTime282_g1340 ) ) + ( cross( float3(0.9,1,1.2) , ( appendResult271_g1340 * float3(1,1,1) ) ) * sin( mulTime282_g1340 ) ) ) * temp_output_303_0_g1340 ) * 0.1 ) + ( ( ( appendResult293_g1340 + ( appendResult292_g1340 * cos( mulTime249_g1340 ) ) + ( cross( float3(1.1,1.3,0.8) , ( appendResult292_g1340 * float3(1.4,0.8,1.1) ) ) * sin( mulTime249_g1340 ) ) ) * temp_output_303_0_g1340 ) * 0.05 ) ) * WindMask_LargeB169_g1340 * saturate( inputMesh.positionOS.y ) ) + ( ( WindMask_LargeC170_g1340 * ( ( ( cos( temp_output_135_0_g1340 ) * sin( temp_output_135_0_g1340 ) * saturate( ase_objectScale ) ) * 0.2 ) + ( ( cos( temp_output_106_0_g1340 ) * sin( temp_output_106_0_g1340 ) * saturate( ase_objectScale ) ) * 0.2 ) + ( ( sin( temp_output_119_0_g1340 ) * cos( temp_output_119_0_g1340 ) ) * 0.2 ) ) * saturate( inputMesh.positionOS.x ) ) * 0.3 ) );
				#elif defined(_WINDTYPE_WINDOFF)
				float3 staticSwitch312_g1340 = temp_cast_5;
				#else
				float3 staticSwitch312_g1340 = ( ( ( ( ( ( appendResult256_g1340 + ( appendResult255_g1340 * cos( mulTime263_g1340 ) ) + ( cross( float3(1.2,0.6,1) , ( appendResult255_g1340 * float3(0.7,1,0.8) ) ) * sin( mulTime263_g1340 ) ) ) * temp_output_303_0_g1340 ) * 0.08 ) + ( ( ( appendResult270_g1340 + ( appendResult271_g1340 * cos( mulTime282_g1340 ) ) + ( cross( float3(0.9,1,1.2) , ( appendResult271_g1340 * float3(1,1,1) ) ) * sin( mulTime282_g1340 ) ) ) * temp_output_303_0_g1340 ) * 0.1 ) + ( ( ( appendResult293_g1340 + ( appendResult292_g1340 * cos( mulTime249_g1340 ) ) + ( cross( float3(1.1,1.3,0.8) , ( appendResult292_g1340 * float3(1.4,0.8,1.1) ) ) * sin( mulTime249_g1340 ) ) ) * temp_output_303_0_g1340 ) * 0.05 ) ) * WindMask_LargeB169_g1340 * saturate( inputMesh.positionOS.y ) ) + ( ( WindMask_LargeC170_g1340 * ( ( ( cos( temp_output_135_0_g1340 ) * sin( temp_output_135_0_g1340 ) * saturate( ase_objectScale ) ) * 0.2 ) + ( ( cos( temp_output_106_0_g1340 ) * sin( temp_output_106_0_g1340 ) * saturate( ase_objectScale ) ) * 0.2 ) + ( ( sin( temp_output_119_0_g1340 ) * cos( temp_output_119_0_g1340 ) ) * 0.2 ) ) * saturate( inputMesh.positionOS.x ) ) * 0.3 ) );
				#endif
				...
				#endif
				float3 vertexValue = ( _GlobalWindStrength * staticSwitch312_g1340 );
						...
						)
			{
				...
				float2 uv_AlbedoMap81_g1337 = packedInput.ase_texcoord5.xy;
				float2 uv_AlbedoMap83_g1337 = packedInput.ase_texcoord5.xy;
				float4 tex2DNode83_g1337 = tex2D( _AlbedoMap, uv_AlbedoMap83_g1337 );
				float2 uv_NoiseMapGrayscale98_g1337 = packedInput.ase_texcoord5.xy;
				float4 transform94_g1337 = mul(GetObjectToWorldMatrix(),float4( 1,1,1,1 ));
				transform94_g1337.xyz = GetAbsolutePositionWS((transform94_g1337).xyz);
				float dotResult4_g1339 = dot( transform94_g1337.xy , float2( 12.9898,78.233 ) );
				float lerpResult10_g1339 = lerp( 0.0 , 1.0 , frac( ( sin( dotResult4_g1339 ) * 43758.55 ) ));
				float3 normalizeResult120_g1337 = normalize( packedInput.ase_texcoord6.xyz );
				float DryLeafPositionMask124_g1337 = ( (distance( normalizeResult120_g1337 , float3( 0,0.8,0 ) )*1.0 + 0.0) * 1 );
				float4 lerpResult46_g1337 = lerp( ( _DryLeafColor * ( tex2DNode83_g1337.g * 2 ) ) , tex2DNode83_g1337 , saturate( (( ( tex2D( _NoiseMapGrayscale, uv_NoiseMapGrayscale98_g1337 ).r * lerpResult10_g1339 * DryLeafPositionMask124_g1337 ) - _SeasonChangeGlobal )*_DryLeavesScale + _DryLeavesOffset) ));
				float4 SeasonControl_Output88_g1337 = lerpResult46_g1337;
				Gradient gradient60_g1337 = NewGradient( 0, 2, 2, float4( 1, 0.276868, 0, 0 ), float4( 0, 1, 0.7818019, 1 ), 0, 0, 0, 0, 0, 0, float2( 1, 0 ), float2( 1, 1 ), 0, 0, 0, 0, 0, 0 );
				float4 transform62_g1337 = mul(GetObjectToWorldMatrix(),float4( 1,1,1,1 ));
				transform62_g1337.xyz = GetAbsolutePositionWS((transform62_g1337).xyz);
				float dotResult4_g1338 = dot( transform62_g1337.xy , float2( 12.9898,78.233 ) );
				float lerpResult10_g1338 = lerp( 0.0 , 1.0 , frac( ( sin( dotResult4_g1338 ) * 43758.55 ) ));
				float4 lerpResult70_g1337 = lerp( SeasonControl_Output88_g1337 , ( ( SeasonControl_Output88_g1337 * 0.5 ) + ( SampleGradient( gradient60_g1337, lerpResult10_g1338 ) * SeasonControl_Output88_g1337 ) ) , _ColorVariation);
				float2 uv_MaskMapRGBA82_g1337 = packedInput.ase_texcoord5.xy;
				float4 lerpResult78_g1337 = lerp( tex2D( _AlbedoMap, uv_AlbedoMap81_g1337 ) , lerpResult70_g1337 , (( _BranchMaskR )?( tex2D( _MaskMapRGBA, uv_MaskMapRGBA82_g1337 ).r ):( 1.0 )));
				float3 temp_output_104_0_g1337 = ( ( packedInput.ase_texcoord6.xyz * float3( 2,1.3,2 ) ) / 25.0 );
				float dotResult107_g1337 = dot( temp_output_104_0_g1337 , temp_output_104_0_g1337 );
				float3 normalizeResult103_g1337 = normalize( packedInput.ase_texcoord6.xyz );
				float SelfShading115_g1337 = saturate( (( pow( abs( saturate( dotResult107_g1337 ) ) , 1.5 ) + ( ( 1.0 - (distance( normalizeResult103_g1337 , float3( 0,0.8,0 ) )*0.5 + 0.0) ) * 0.6 ) )*0.92 + -0.16) );
				#ifdef _SELFSHADING_ON
				float4 staticSwitch74_g1337 = ( lerpResult78_g1337 * (SelfShading115_g1337*_VertexLighting + _VertexShadow) );
				#else
				float4 staticSwitch74_g1337 = lerpResult78_g1337;
				#endif
				float4 LeafColorVariationSeasons_Output91_g1337 = staticSwitch74_g1337;
				float dotResult151_g1337 = dot( V , -( -_DirectionalLightDatas[0].forward + packedInput.ase_texcoord6.xyz ) );
				float2 uv_MaskMapRGBA152_g1337 = packedInput.ase_texcoord5.xy;
				...
				float TobyTranslucency153_g1337 = ( saturate( dotResult151_g1337 ) * tex2D( _MaskMapRGBA, uv_MaskMapRGBA152_g1337 ).b * ase_lightColor.a );
				float TranslucencyIntensity39_g1337 = _TranslucencyPower;
				float4 Albedo_Output154_g1337 = ( ( _AlebedoColor * LeafColorVariationSeasons_Output91_g1337 ) * (1.0 + (TobyTranslucency153_g1337 - 0.0) * (TranslucencyIntensity39_g1337 - 1.0) / (1.0 - 0.0)) );
				
				float2 uv_NormalMap87_g1337 = packedInput.ase_texcoord5.xy;
				float3 unpack87_g1337 = UnpackNormalScale( tex2D( _NormalMap, uv_NormalMap87_g1337 ), _NormalIntenisty );
				unpack87_g1337.z = lerp( 1, unpack87_g1337.z, saturate(_NormalIntenisty) );
				float3 Normal_Output155_g1337 = unpack87_g1337;
				
				float2 uv_MaskMapRGBA79_g1337 = packedInput.ase_texcoord5.xy;
				float4 tex2DNode79_g1337 = tex2D( _MaskMapRGBA, uv_MaskMapRGBA79_g1337 );
				float Smoothness_Output35_g1337 = ( tex2DNode79_g1337.a * _SmoothnessIntensity );
				
				float AoMapBase31_g1337 = tex2DNode79_g1337.g;
				float Ao_Output141_g1337 = ( pow( abs( AoMapBase31_g1337 ) , _AmbientOcclusionIntensity ) * ( 1.5 / ( ( saturate( TobyTranslucency153_g1337 ) * TranslucencyIntensity39_g1337 ) + 1.5 ) ) );
				
				float2 uv_AlbedoMap80_g1337 = packedInput.ase_texcoord5.xy;
				float Opacity_Output86_g1337 = ( 1.0 - tex2D( _AlbedoMap, uv_AlbedoMap80_g1337 ).a );
				
				surfaceDescription.BaseColor = Albedo_Output154_g1337.rgb;
				surfaceDescription.Normal = Normal_Output155_g1337;
				...
				surfaceDescription.Smoothness = Smoothness_Output35_g1337;
				surfaceDescription.Occlusion = Ao_Output141_g1337;
				surfaceDescription.Alpha = Opacity_Output86_g1337;
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				BuiltinData builtinData;
				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;
				float2 uv_AlbedoMap81_g1337 = packedInput.ase_texcoord2.xy;
				float2 uv_AlbedoMap83_g1337 = packedInput.ase_texcoord2.xy;
				float4 tex2DNode83_g1337 = tex2D( _AlbedoMap, uv_AlbedoMap83_g1337 );
				float2 uv_NoiseMapGrayscale98_g1337 = packedInput.ase_texcoord2.xy;
				float4 transform94_g1337 = mul(GetObjectToWorldMatrix(),float4( 1,1,1,1 ));
				transform94_g1337.xyz = GetAbsolutePositionWS((transform94_g1337).xyz);
				float dotResult4_g1339 = dot( transform94_g1337.xy , float2( 12.9898,78.233 ) );
				float lerpResult10_g1339 = lerp( 0.0 , 1.0 , frac( ( sin( dotResult4_g1339 ) * 43758.55 ) ));
				float3 normalizeResult120_g1337 = normalize( packedInput.ase_texcoord3.xyz );
				float DryLeafPositionMask124_g1337 = ( (distance( normalizeResult120_g1337 , float3( 0,0.8,0 ) )*1.0 + 0.0) * 1 );
				float4 lerpResult46_g1337 = lerp( ( _DryLeafColor * ( tex2DNode83_g1337.g * 2 ) ) , tex2DNode83_g1337 , saturate( (( ( tex2D( _NoiseMapGrayscale, uv_NoiseMapGrayscale98_g1337 ).r * lerpResult10_g1339 * DryLeafPositionMask124_g1337 ) - _SeasonChangeGlobal )*_DryLeavesScale + _DryLeavesOffset) ));
				float4 SeasonControl_Output88_g1337 = lerpResult46_g1337;
				Gradient gradient60_g1337 = NewGradient( 0, 2, 2, float4( 1, 0.276868, 0, 0 ), float4( 0, 1, 0.7818019, 1 ), 0, 0, 0, 0, 0, 0, float2( 1, 0 ), float2( 1, 1 ), 0, 0, 0, 0, 0, 0 );
				...
				float lerpResult10_g1338 = lerp( 0.0 , 1.0 , frac( ( sin( dotResult4_g1338 ) * 43758.55 ) ));
				float4 lerpResult70_g1337 = lerp( SeasonControl_Output88_g1337 , ( ( SeasonControl_Output88_g1337 * 0.5 ) + ( SampleGradient( gradient60_g1337, lerpResult10_g1338 ) * SeasonControl_Output88_g1337 ) ) , _ColorVariation);
				float2 uv_MaskMapRGBA82_g1337 = packedInput.ase_texcoord2.xy;
				float4 lerpResult78_g1337 = lerp( tex2D( _AlbedoMap, uv_AlbedoMap81_g1337 ) , lerpResult70_g1337 , (( _BranchMaskR )?( tex2D( _MaskMapRGBA, uv_MaskMapRGBA82_g1337 ).r ):( 1.0 )));
				float3 temp_output_104_0_g1337 = ( ( packedInput.ase_texcoord3.xyz * float3( 2,1.3,2 ) ) / 25.0 );
				float dotResult107_g1337 = dot( temp_output_104_0_g1337 , temp_output_104_0_g1337 );
				float3 normalizeResult103_g1337 = normalize( packedInput.ase_texcoord3.xyz );
				float SelfShading115_g1337 = saturate( (( pow( abs( saturate( dotResult107_g1337 ) ) , 1.5 ) + ( ( 1.0 - (distance( normalizeResult103_g1337 , float3( 0,0.8,0 ) )*0.5 + 0.0) ) * 0.6 ) )*0.92 + -0.16) );
				#ifdef _SELFSHADING_ON
				float4 staticSwitch74_g1337 = ( lerpResult78_g1337 * (SelfShading115_g1337*_VertexLighting + _VertexShadow) );
				#else
				...
				float dotResult151_g1337 = dot( ase_worldViewDir , -( -_DirectionalLightDatas[0].forward + packedInput.ase_texcoord3.xyz ) );
				float2 uv_MaskMapRGBA152_g1337 = packedInput.ase_texcoord2.xy;
				float ase_lightIntensity = max( max( _DirectionalLightDatas[0].color.r, _DirectionalLightDatas[0].color.g ), _DirectionalLightDatas[0].color.b );
				float4 ase_lightColor = float4( _DirectionalLightDatas[0].color.rgb / ase_lightIntensity, ase_lightIntensity );
				float TobyTranslucency153_g1337 = ( saturate( dotResult151_g1337 ) * tex2D( _MaskMapRGBA, uv_MaskMapRGBA152_g1337 ).b * ase_lightColor.a );
				float TranslucencyIntensity39_g1337 = _TranslucencyPower;
				...
				float2 uv_NormalMap87_g1337 = packedInput.ase_texcoord2.xy;
				float3 unpack87_g1337 = UnpackNormalScale( tex2D( _NormalMap, uv_NormalMap87_g1337 ), _NormalIntenisty );
				unpack87_g1337.z = lerp( 1, unpack87_g1337.z, saturate(_NormalIntenisty) );
				float3 Normal_Output155_g1337 = unpack87_g1337;
				
				float2 uv_MaskMapRGBA79_g1337 = packedInput.ase_texcoord2.xy;
				float4 tex2DNode79_g1337 = tex2D( _MaskMapRGBA, uv_MaskMapRGBA79_g1337 );
				float Smoothness_Output35_g1337 = ( tex2DNode79_g1337.a * _SmoothnessIntensity );
				...
				float2 uv_AlbedoMap80_g1337 = packedInput.ase_texcoord2.xy;
				float Opacity_Output86_g1337 = ( 1.0 - tex2D( _AlbedoMap, uv_AlbedoMap80_g1337 ).a );
		...
		Pass
		{
			...
			UNITY_SETUP_INSTANCE_ID(packedInput);
				...
				float2 uv_AlbedoMap80_g1337 = packedInput.ase_texcoord1.xy;
				float Opacity_Output86_g1337 = ( 1.0 - tex2D( _AlbedoMap, uv_AlbedoMap80_g1337 ).a );
		...
		Pass
		{
			...
			UNITY_SETUP_INSTANCE_ID(packedInput);
				...
				float2 uv_NormalMap87_g1337 = packedInput.ase_texcoord3.xy;
				float3 unpack87_g1337 = UnpackNormalScale( tex2D( _NormalMap, uv_NormalMap87_g1337 ), _NormalIntenisty );
				unpack87_g1337.z = lerp( 1, unpack87_g1337.z, saturate(_NormalIntenisty) );
				float3 Normal_Output155_g1337 = unpack87_g1337;
				
				float2 uv_MaskMapRGBA79_g1337 = packedInput.ase_texcoord3.xy;
				float4 tex2DNode79_g1337 = tex2D( _MaskMapRGBA, uv_MaskMapRGBA79_g1337 );
				float Smoothness_Output35_g1337 = ( tex2DNode79_g1337.a * _SmoothnessIntensity );
				
				float2 uv_AlbedoMap80_g1337 = packedInput.ase_texcoord3.xy;
				float Opacity_Output86_g1337 = ( 1.0 - tex2D( _AlbedoMap, uv_AlbedoMap80_g1337 ).a );
		...
		Pass
		{
						...
						)
			{
				...
				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;
				float2 uv_AlbedoMap81_g1337 = packedInput.ase_texcoord7.xy;
				float2 uv_AlbedoMap83_g1337 = packedInput.ase_texcoord7.xy;
				float4 tex2DNode83_g1337 = tex2D( _AlbedoMap, uv_AlbedoMap83_g1337 );
				float2 uv_NoiseMapGrayscale98_g1337 = packedInput.ase_texcoord7.xy;
				float4 transform94_g1337 = mul(GetObjectToWorldMatrix(),float4( 1,1,1,1 ));
				transform94_g1337.xyz = GetAbsolutePositionWS((transform94_g1337).xyz);
				float dotResult4_g1339 = dot( transform94_g1337.xy , float2( 12.9898,78.233 ) );
				float lerpResult10_g1339 = lerp( 0.0 , 1.0 , frac( ( sin( dotResult4_g1339 ) * 43758.55 ) ));
				float3 normalizeResult120_g1337 = normalize( packedInput.ase_texcoord8.xyz );
				float DryLeafPositionMask124_g1337 = ( (distance( normalizeResult120_g1337 , float3( 0,0.8,0 ) )*1.0 + 0.0) * 1 );
				float4 lerpResult46_g1337 = lerp( ( _DryLeafColor * ( tex2DNode83_g1337.g * 2 ) ) , tex2DNode83_g1337 , saturate( (( ( tex2D( _NoiseMapGrayscale, uv_NoiseMapGrayscale98_g1337 ).r * lerpResult10_g1339 * DryLeafPositionMask124_g1337 ) - _SeasonChangeGlobal )*_DryLeavesScale + _DryLeavesOffset) ));
				float4 SeasonControl_Output88_g1337 = lerpResult46_g1337;
				Gradient gradient60_g1337 = NewGradient( 0, 2, 2, float4( 1, 0.276868, 0, 0 ), float4( 0, 1, 0.7818019, 1 ), 0, 0, 0, 0, 0, 0, float2( 1, 0 ), float2( 1, 1 ), 0, 0, 0, 0, 0, 0 );
				...
				float lerpResult10_g1338 = lerp( 0.0 , 1.0 , frac( ( sin( dotResult4_g1338 ) * 43758.55 ) ));
				float4 lerpResult70_g1337 = lerp( SeasonControl_Output88_g1337 , ( ( SeasonControl_Output88_g1337 * 0.5 ) + ( SampleGradient( gradient60_g1337, lerpResult10_g1338 ) * SeasonControl_Output88_g1337 ) ) , _ColorVariation);
				float2 uv_MaskMapRGBA82_g1337 = packedInput.ase_texcoord7.xy;
				float4 lerpResult78_g1337 = lerp( tex2D( _AlbedoMap, uv_AlbedoMap81_g1337 ) , lerpResult70_g1337 , (( _BranchMaskR )?( tex2D( _MaskMapRGBA, uv_MaskMapRGBA82_g1337 ).r ):( 1.0 )));
				float3 temp_output_104_0_g1337 = ( ( packedInput.ase_texcoord8.xyz * float3( 2,1.3,2 ) ) / 25.0 );
				float dotResult107_g1337 = dot( temp_output_104_0_g1337 , temp_output_104_0_g1337 );
				float3 normalizeResult103_g1337 = normalize( packedInput.ase_texcoord8.xyz );
				float SelfShading115_g1337 = saturate( (( pow( abs( saturate( dotResult107_g1337 ) ) , 1.5 ) + ( ( 1.0 - (distance( normalizeResult103_g1337 , float3( 0,0.8,0 ) )*0.5 + 0.0) ) * 0.6 ) )*0.92 + -0.16) );
				#ifdef _SELFSHADING_ON
				float4 staticSwitch74_g1337 = ( lerpResult78_g1337 * (SelfShading115_g1337*_VertexLighting + _VertexShadow) );
				#else
				...
				#endif
				float4 LeafColorVariationSeasons_Output91_g1337 = staticSwitch74_g1337;
				float dotResult151_g1337 = dot( V , -( -_DirectionalLightDatas[0].forward + packedInput.ase_texcoord8.xyz ) );
				float2 uv_MaskMapRGBA152_g1337 = packedInput.ase_texcoord7.xy;
				float ase_lightIntensity = max( max( _DirectionalLightDatas[0].color.r, _DirectionalLightDatas[0].color.g ), _DirectionalLightDatas[0].color.b );
				float4 ase_lightColor = float4( _DirectionalLightDatas[0].color.rgb / ase_lightIntensity, ase_lightIntensity );
				float TobyTranslucency153_g1337 = ( saturate( dotResult151_g1337 ) * tex2D( _MaskMapRGBA, uv_MaskMapRGBA152_g1337 ).b * ase_lightColor.a );
				float TranslucencyIntensity39_g1337 = _TranslucencyPower;
				...
				float2 uv_NormalMap87_g1337 = packedInput.ase_texcoord7.xy;
				float3 unpack87_g1337 = UnpackNormalScale( tex2D( _NormalMap, uv_NormalMap87_g1337 ), _NormalIntenisty );
				unpack87_g1337.z = lerp( 1, unpack87_g1337.z, saturate(_NormalIntenisty) );
				float3 Normal_Output155_g1337 = unpack87_g1337;
				
				float2 uv_MaskMapRGBA79_g1337 = packedInput.ase_texcoord7.xy;
				float4 tex2DNode79_g1337 = tex2D( _MaskMapRGBA, uv_MaskMapRGBA79_g1337 );
				float Smoothness_Output35_g1337 = ( tex2DNode79_g1337.a * _SmoothnessIntensity );
				...
				float2 uv_AlbedoMap80_g1337 = packedInput.ase_texcoord7.xy;
				float Opacity_Output86_g1337 = ( 1.0 - tex2D( _AlbedoMap, uv_AlbedoMap80_g1337 ).a );
...
WireConnection;749;0;763;162
WireConnection;749;1;763;168
WireConnection;749;7;763;167
WireConnection;749;8;763;163
WireConnection;749;9;763;166
WireConnection;749;11;764;229
ASEEND*/
//CHKSM=453B81D5899E6C34801395D977626FE659323560